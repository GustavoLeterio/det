...
export default function PlateAndCupComponent(props: Props) {
  ...
  const [state, setState] = useState({
    carbohidrateIsPresent: isItemPresentByNutrient(Nutrients.CARBOHYDRATE),
    ...
    <Content>
      <Plate source={require("../../../assets/PlateButtons/plate.png")}>
        <Button
          move={{ x: 19, y: 31 }}
          zIndex={2}
          opacity={state.carbohidrateIsPresent ? 1 : 0.5}
          onPress={() =>
            handleClick(state.carbohidrateIsPresent, Nutrients.CARBOHYDRATE)
          }
        >
          <Image
            source={require("../../../assets/PlateButtons/rice.png")}
          ></Image>
        </Button>
        <Button
          move={{ x: 71, y: 31 }}
          zIndex={0}
          opacity={state.fiberIsPresent ? 1 : 0.5}
          onPress={() => handleClick(state.fiberIsPresent, Nutrients.FIBER)}
        >
          <Image
            source={require("../../../assets/PlateButtons/lettuce.png")}
          ></Image>
        </Button>
        <Button
          move={{ x: 22, y: 90 }}
          zIndex={1}
          opacity={state.fatIsPresent ? 1 : 0.5}
          onPress={() => handleClick(state.fatIsPresent, Nutrients.FAT)}
        >
          <Image
            source={require("../../../assets/PlateButtons/avocado.png")}
          ></Image>
        </Button>
        <Button
          move={{ x: 74, y: 97 }}
          zIndex={3}
          opacity={state.proteinIsPresent ? 1 : 0.5}
          onPress={() => handleClick(state.proteinIsPresent, Nutrients.PROTEIN)}
        >
          <Image
            source={require("../../../assets/PlateButtons/meat.png")}
          ></Image>
        </Button>
      </Plate>
